...
--Montar um relatório em que conste todos os dados dos empregados (inclusive da loja a que eles pertencem) e os clientes que esses atendem (inclua neste relatório também todos os dados dos
SELECT f.nome, f.sobrenome, f.email, f.cargo, l.cidade, l.telefone, l.enderecolinha1, l.enderecolinha2, c.nomecliente, c.sobrenomecontato, c.cidade FROM funcionarios f
    INNER JOIN lojas l ON
        f.codloja = l.codloja 
    INNER JOIN clientes c ON
        f.numfuncionario = c.numfuncionarioreprvendas; 
