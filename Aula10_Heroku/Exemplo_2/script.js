...
function iniciar(){
    const elementos = document.getElementsByClassName('cont3'); //identificando os elementos da pagina com que vai trabalhar

    for (const elemento of elementos) {
        elemento.addEventListener('click', marcarElementoSelecionado); //addEventListener relaciona um evento a um comando a ser realizado na página
    }
